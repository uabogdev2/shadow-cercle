...
<template>
  <div class="cupid-phase h-screen w-screen flex flex-col relative overflow-hidden">
    ...
    <div class="absolute inset-0 phase-night">
      ...
      <div class="absolute top-20 left-10 w-32 h-32 bg-rose-500/18 rounded-full filter blur-3xl"></div>
      <div class="absolute bottom-40 right-20 w-48 h-48 bg-pink-500/14 rounded-full filter blur-3xl"></div>
    </div>
